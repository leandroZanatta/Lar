...
import static br.com.sysdesc.util.constants.MensagemConstants.MENSAGEM_CONEXAO_INVALIDA;
...
import static br.com.sysdesc.util.resources.Resources.OPTION_ERRO;
...
public class FrmConexao extends JDialog {
	...
	private void initComponents() {
		...
		lblUrl.setBounds(10, 70, 100, 14);
		lblBancoDeDados.setBounds(10, 25, 120, 15);
		lblPorta.setBounds(280, 70, 46, 14);
		lblUsuario.setBounds(10, 115, 60, 14);
	...
	private void salvarConfiguracao() {
		...
		try {
			...
			FileUtils.writeStringToFile(new File(Configuracoes.CONEXAO), toBlowfish(writer.toString()),
