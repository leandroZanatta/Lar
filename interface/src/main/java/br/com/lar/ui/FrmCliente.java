...
public class FrmCliente extends AbstractInternalFrame {
    ...
    private JLabel lbRacacor;
    private JLabel lbEscolaridade;
    private JLabel lbReligiao;
    ...
    private void initComponents() throws ParseException {
        ...
        lbNomePai = new JLabel("Nome do Pai:");
        lbNomeMae = new JLabel("Nome da Mãe:");
        lbRacacor = new JLabel("Raça/Cor:");
        lbReligiao = new JLabel("Religião:");
